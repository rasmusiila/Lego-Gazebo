...
class GazColor:
    ...
    def callback(self, data):
        if self.times_listened >= 1:
            ...
            self.raw_total = self.get_raw_total()
    ...
    def get_color_dict(self):
        ...
        return color_dict
        # print("tulemus number: ", self.times_listened)
    ...
    def get_raw_total(self):
        ...
        return red_total, green_total, blue_total, total_pixels
    ...
    def get_image_raw_color(self):
        ...
        return (red_total / max) * 255, (green_total / max) * 255, (blue_total / max) * 255
